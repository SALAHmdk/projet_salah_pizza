...
CREATE TABLE `pizza`  (
  ...
  `image1_chemin` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`NROPIZZ`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 457 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of pizza
-- ----------------------------
INSERT INTO `pizza` VALUES (1, 'pizza caviar', 250.00, 'd:/image_12.jpg');
INSERT INTO `pizza` VALUES (2, 'La Seguin', 13.50, NULL);
INSERT INTO `pizza` VALUES (3, 'La From', 14.50, NULL);
INSERT INTO `pizza` VALUES (4, 'La Fermière', 12.50, NULL);
INSERT INTO `pizza` VALUES (5, 'La chausson', 13.00, NULL);
INSERT INTO `pizza` VALUES (6, 'La Provençale', 12.50, NULL);
INSERT INTO `pizza` VALUES (7, 'La Caramba', 14.50, NULL);
INSERT INTO `pizza` VALUES (8, 'l\'Orient Express', 14.50, NULL);
INSERT INTO `pizza` VALUES (9, 'La Gourmande', 14.50, NULL);
INSERT INTO `pizza` VALUES (10, 'La primeure', 12.50, NULL);
INSERT INTO `pizza` VALUES (11, 'La Péloponèse', 14.50, NULL);
INSERT INTO `pizza` VALUES (12, 'La Savoyarde', 14.50, NULL);
INSERT INTO `pizza` VALUES (13, 'la Pêcheur', 13.50, NULL);
INSERT INTO `pizza` VALUES (456, 'puree', 19.20, NULL);
